...
def main():
    ...
    if total == 0:
        ...
        write_progress(100, 100, "Toutes les actions historiques sont déjà importées !", "Importation")
        return
    ...
    write_progress(total, total, f"Importation terminée. Succès: {success_count}, Échecs: {failure_count}", "Importation")
