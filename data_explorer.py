    ...
    <body class="bg-slate-950 text-slate-100 min-h-screen flex flex-col antialiased">
        ...
        <script>
            ...
            function getSymbolLogoHtml(symbol, name = '', assetClass = 'stocks') {
                ...
                // SVG Brand Icons for major stocks (No network requests, 100% offline, crisp vector rendering)
                const majorStockSvgs = {
                    'AAPL': `<svg viewBox="0 0 24 24" class="w-5 h-5 fill-white" xmlns="http://www.w3.org/2000/svg"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 4.17c.66-.81 1.11-1.93.99-3.06-1 .04-2.15.67-2.87 1.51-.62.72-1.16 1.86-1.01 2.98 1.1.09 2.22-.62 2.89-1.43Z"/></svg>`,
                    'MSFT': `<svg viewBox="0 0 23 23" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg"><rect width="11" height="11" fill="#F25022"/><rect x="12" width="11" height="11" fill="#7FBA00"/><rect y="12" width="11" height="11" fill="#00A4EF"/><rect x="12" y="12" width="11" height="11" fill="#FFB900"/></svg>`,
                    'GOOGL': `<svg viewBox="0 0 24 24" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z" fill="#EA4335"/></svg>`,
                    'GOOG': `<svg viewBox="0 0 24 24" class="w-5 h-5" xmlns="http://www.w3.org/2000/svg"><path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/><path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/><path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.85-2.22.81-.63z" fill="#FBBC05"/><path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.06l3.66 2.84c.87-2.6 3.3-4.52 6.16-4.52z" fill="#EA4335"/></svg>`,
                    'NVDA': `<svg viewBox="0 0 24 24" class="w-5 h-5 fill-[#76B900]" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1.29 14.29c-.39.39-1.02.39-1.41 0L8.29 12.7c-.39-.39-.39-1.02 0-1.41l3.59-3.59c.39-.39 1.02-.39 1.41 0l3.59 3.59c.39.39.39 1.02 0 1.41l-3.59 3.59z"/></svg>`,
                    'TSLA': `<svg viewBox="0 0 24 24" class="w-5 h-5 fill-[#E82127]" xmlns="http://www.w3.org/2000/svg"><path d="M12 2c-.1 0-.2 0-.3.1L2.3 5.4c-.2.1-.3.3-.3.5v12.2c0 .2.1.4.3.5l9.4 3.3c.1 0 .2.1.3.1.1 0 .2 0 .3-.1l9.4-3.3c.2-.1.3-.3.3-.5V5.9c0-.2-.1-.4-.3-.5l-9.4-3.3c-.1-.1-.2-.1-.3-.1zm0 3.2c1.9 0 3.5.7 4.7 1.9l-1.4 1.4c-.9-.9-2.1-1.4-3.3-1.4-2.6 0-4.8 2.1-4.8 4.8s2.2 4.8 4.8 4.8c1.2 0 2.4-.5 3.3-1.4l1.4 1.4c-1.2 1.2-2.8 1.9-4.7 1.9-3.7 0-6.7-3-6.7-6.7S8.3 5.2 12 5.2z"/></svg>`,
                    'AMZN': `<svg viewBox="0 0 24 24" class="w-5 h-5 fill-[#FF9900]" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1.9 14.5c-.8.6-1.9.9-3 .9-1.8 0-3.3-.9-3.9-2.3-.2-.5 0-1 .4-1.3l1.1-.9c.4-.3.9-.2 1.2.1.4.4.9.6 1.4.6.6 0 1.2-.3 1.5-.8.3-.5.3-1.1-.1-1.5-.4-.4-.9-.6-1.5-.6h-1c-.5 0-1-.4-1-1v-1.5c0-.5.5-1 1-1h1c.5 0 1-.2 1.4-.6.4-.4.4-1 .1-1.5-.3-.5-.9-.8-1.5-.8-.5 0-1 .2-1.4.6-.3.3-.8.4-1.2.1l-1.1-.9c-.4-.3-.5-.8-.3-1.3C8.7 5.9 10.2 5 12 5c1.1 0 2.2.3 3 .9.8.6 1.3 1.5 1.3 2.6 0 1.5-1.1 2.7-2.6 3 1.5.3 2.6 1.5 2.6 3 0 1.1-.5 2-1.4 2.6z"/></svg>`,
                    'META': `<svg viewBox="0 0 24 24" class="w-5 h-5 fill-[#0064E0]" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm6.2 12.8c-.8.8-2 1.2-3.2 1.2-1.3 0-2.4-.5-3.2-1.2l-1.8-1.8-1.8 1.8c-.8.8-2 1.2-3.2 1.2-1.2 0-2.4-.4-3.2-1.2-.8-.8-1.2-2-1.2-3.2s.4-2.4 1.2-3.2c.8-.8 2-1.2 3.2-1.2 1.3 0 2.4.5 3.2 1.2l1.8 1.8 1.8-1.8c.8-.8 2-1.2 3.2-1.2 1.2 0 2.4.4 3.2 1.2.8.8 1.2 2 1.2 3.2s-.4 2.4-1.2 3.2z"/></svg>`
                };
                ...
                if (assetClass === 'stocks' && majorStockSvgs[symbol]) {
                    return `<div class="w-5 h-5 rounded-full flex items-center justify-center bg-slate-900 border border-slate-800 shadow-inner">${majorStockSvgs[symbol]}</div>`;
                }
            ...
            async function pollIngestProgress() {
                try {
                    ...
                    if (progress.active) {
                        ...
                        if (syncTimeEl) {
                            syncTimeEl.innerText = "Sync in progress...";
                        ...
                        if (syncTimeEl) {
                            if (progress.status && progress.status.includes("terminée")) {
                                syncTimeEl.innerText = "Up to date (Done)";
                                syncTimeEl.className = "text-emerald-400 font-medium";
                            } else {
                                syncTimeEl.innerText = "Standby";
                        ...
                        if (isPollingProgress) {
                            ...
                            statusText.innerText = progress.status || 'Operation completed!';
                            ...
                            setTimeout(() => {
                                ...
                                if (btnBloomberg) { btnBloomberg.disabled = false; btnBloomberg.innerText = "Import Bloomberg Data"; }
                                if (btnMissing) { btnMissing.disabled = false; btnMissing.innerText = "Import Missing Tickers"; }
                                if (btnUpdateAll) { btnUpdateAll.disabled = false; btnUpdateAll.innerText = "Refresh All (2022-2026)"; }
            ...
            function onAssetClassChange() {
                ...
                // Select NVDA by default for stocks, EURUSD for forex, BTC for crypto
                if (currentAssetClassSymbols.length > 0) {
                    let defaultSymbol = currentAssetClassSymbols[0];
                    if (assetClass === 'stocks') {
                        const nvdaMatch = currentAssetClassSymbols.find(item => item.symbol === 'NVDA');
                        if (nvdaMatch) defaultSymbol = nvdaMatch;
                    } else if (assetClass === 'forex') {
                        const eurusdMatch = currentAssetClassSymbols.find(item => item.symbol === 'EURUSD');
                        if (eurusdMatch) defaultSymbol = eurusdMatch;
                    } else if (assetClass === 'crypto') {
                        const btcMatch = currentAssetClassSymbols.find(item => item.symbol === 'BTCUSD' || item.symbol === 'BTC');
                        if (btcMatch) defaultSymbol = btcMatch;
                    }
                    selectSymbol(defaultSymbol.symbol, defaultSymbol.label, false);
                } else {
                    selectSymbol('', '', false);
                }
            ...
            function populateRawTable(data, isMacro) {
                ...
                rowCountEl.innerText = `Showing last ${slicedData.length} rows (out of ${data.length})`;
            ...
            async function loadFinancials(symbol) {
                ...
                try {
                    ...
                    // Filter out rows without revenue to keep the UI clean
                    const filteredData = data.filter(row => row.revenue !== null && row.revenue !== undefined && row.revenue !== 0);
                    ...
                    filteredData.forEach(row => {
                        // Calculate quarter and year from report_date as fallback for fiscal_period
                        let period = row.fiscal_period;
                        if (!period && row.report_date) {
                        ...
                        tr.innerHTML = `
                            ...
                            <td class="py-2 px-3 text-slate-400 font-medium">${period}</td>
                            <td class="py-2 px-3 text-right font-mono">${row.revenue ? formatLargeNumber(row.revenue) : '-'}</td>
                            <td class="py-2 px-3 text-right font-mono ${row.net_income >= 0 ? 'text-emerald-400' : 'text-rose-400'}">${row.net_income ? formatLargeNumber(row.net_income) : '-'}</td>
                            <td class="py-2 px-3 text-right font-mono">${row.eps !== null ? row.eps.toFixed(2) : '-'}</td>
                            <td class="py-2 px-3 text-right font-mono">${row.cash ? formatLargeNumber(row.cash) : '-'}</td>
                            <td class="py-2 px-3 text-right font-mono">${row.operating_cf ? formatLargeNumber(row.operating_cf) : '-'}</td>
                            <td class="py-2 px-3 text-right font-mono font-semibold ${row.free_cash_flow >= 0 ? 'text-emerald-400' : 'text-rose-400'}">${row.free_cash_flow ? formatLargeNumber(row.free_cash_flow) : '-'}</td>
                        `;
                        tbody.appendChild(tr);
                    });
                } catch (e) {
